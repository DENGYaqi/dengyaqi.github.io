...
categories: [Java]
tags: [java]
description: 以面向对象为起点，梳理 Java 的反射、异常、泛型、注解与 SPI 扩展机制。
pin: true
---
...
Java学习路径 : [Java基础的核心思想](https://dengyaqi.github.io/posts/2024/08/28/java/) -> [Java容器](https://dengyaqi.github.io/posts/2024/09/03/java-collections/) -> Java多线程与并发 -> Java IO/NIO/AIO -> Java设计模式 -> Java应用
